...
export function registerOnboardCommand(program: Command) {
  program
    ...
    .option(
      "--auth-choice <choice>",
      "Auth: setup-token|claude-cli|token|chutes|openai-codex|openai-api-key|xai-api-key|qianfan-api-key|openrouter-api-key|litellm-api-key|ai-gateway-api-key|cloudflare-ai-gateway-api-key|moonshot-api-key|moonshot-api-key-cn|kimi-code-api-key|synthetic-api-key|venice-api-key|redpill-api-key|together-api-key|codex-cli|gemini-api-key|zai-api-key|zai-coding-global|zai-coding-cn|zai-global|zai-cn|xiaomi-api-key|apiKey|minimax-api|minimax-api-lightning|opencode-zen|custom-api-key|skip",
    )
    .option(
      "--token-provider <id>",
